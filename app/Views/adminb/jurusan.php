        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
              ...
              <!-- Input Jurusan Modal -->
              <div class="card-body">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#inputJurusanModal">
                  Tambah Jurusan
                </button>

                <div class="modal fade" id="inputJurusanModal" tabindex="-1" aria-labelledby="inputJurusanModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="inputJurusanModalLabel">Form Input Jurusan</h5>
                      ...
                      <div class="modal-body">
                        ...
                        <form action="/admin/savejurusan" method="post">
                          <?= csrf_field(); ?>

                          <div class="form-group row">
                            <label for="kode" class="col-sm-3 col-form-label">Kode Jurusan:</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="kode" name="kode"
                                placeholder="Masukkan Kode Jurusan" value="<?= old('kode') ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group row mt-3">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="nama" name="nama"
                                placeholder="Masukkan Nama Jurusan" value="<?= old('nama') ?>" required>
                            </div>
                          </div>
                      </div>
                      ...
                      <?php if (!empty($jurusan)) : ?>
                        ...
                        foreach ($jurusan as $row): ?>
                          <tr>
                            ...
                            <td>
                              <!-- Perbaiki URL Edit -->
                              <a href="<?= base_url('/jurusan/editjurusan/' . $row['id']) ?>" class="btn btn-primary btn-sm">Edit</a>

                              <!-- Perbaiki URL Hapus -->
                              <a href="<?= base_url('/admin/deletejurusan/' . $row['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      <?php else : ?>
