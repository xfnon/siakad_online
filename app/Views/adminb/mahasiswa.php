                ...
                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form-horizontal" action="/admin/savemhs" method="post">
                        ...
                        <div class="form-group row">
                          <label class="control-label col-sm-3 align-self-center mb-0" for="prodi">Prodi :</label>
                          <div class="col-sm-9">
                            <select name="jurusan" class="form-control" id="prodi" required>
                              <option value="">Pilih Program Studi</option>
                              <?php foreach ($jurusan as $j): ?>
                                <option value="<?= esc($j['kode']) ?>">
                        ...
                        <div class="form-group row">
                          <label class="control-label col-sm-3 align-self-center mb-0" for="semester">Semester :</label>
                          <div class="col-sm-9">
                  ...
                  <tbody>
                    <?php foreach ($mahasiswa as $row): ?>
                      <tr>
                        ...
                        <td><?= $row['angkatan']; ?></td>
                        <th>
                          <a href="/admin/deletemhs/<?= $row['id_mhs']; ?>" class="btn btn-danger">Delete</a>
