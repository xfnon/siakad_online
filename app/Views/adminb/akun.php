        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse show" id="sidebar-auth" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/admin/akun">
                  <i class="icon">
                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                      <g>
                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Form Input Akun</h5>
                    ...
                    <div class="modal-body">
                      <form class="form-horizontal" action="/admin/savemhs" method="post">
                        ...
                        <div class="form-group row">
                          <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Password :</label>
                          <div class="col-sm-9">
                  ...
                  <tbody>
                    <?php foreach ($akun as $row): ?>
                      <tr>
                        ...
                        <td><?= $row['level']; ?></td>
                        <th>
                          <a href="/admin/deleteakun/<?= $row['id_akun']; ?>" class="btn btn-danger">Delete</a>
                          <a href="/admin/editakun/<?= $row['id_akun']; ?>" class="btn btn-primary">Edit</a>
                        </th>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
