    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/master-mhs/index">
                            <i class="icon">
      ...
      <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="/master-mhs/save" method="post">
                <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">NIM :</label>
                        <div class="col-sm-9">
                        <input type="number" name="nim" class="form-control" placeholder="Masukan NIM" required>
                        </div>
                    </div>
                <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Nama Lengkap :</label>
                        <div class="col-sm-9">
                        <input type="text" name="nama" class="form-control" id placeholder="Masukan Nama Lengkap" required>
                    </div>
                </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="jk">Jenis Kelamin:</label>
                        <div class="col-sm-9">
                          <div class="form-check d-block">
                              <input class="form-check-input" type="radio" name="jk" id="jkLaki" value="l">
                              <label class="form-check-label" for="jkLaki">
                                  Laki-Laki
                              </label>
                          </div>
                          <div class="form-check d-block">
                              <input class="form-check-input" type="radio" name="jk" id="jkPerempuan" value="p">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="pwd2">Nomor Telepon :</label>
                        <div class="col-sm-9">
                        <input type="number" name="no_telp" class="form-control" id="pwd2" placeholder="Masukan Nomor Telepon">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Alamat :</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" name="alamat" id="exampleFormControlTextarea1" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Prodi :</label>
                        <div class="col-sm-9">
                        <input type="text" name="prodi" class="form-control" id placeholder="Masukan Prodi" required>
                    </div>
                </div>
                <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Fakultas :</label>
                        <div class="col-sm-9">
                        <input type="text" name="fakultas" class="form-control" id placeholder="Masukan Fakultas" required>
                    </div>
                </div>
                <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Tahun Masuk :</label>
                        <div class="col-sm-9">
                        <input type="number" name="tahun" class="form-control" id placeholder="Masukan Tahun Masuk" required>
                    </div>
                </div>
                <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Angkatan :</label>
                        <div class="col-sm-9">
                        <input type="number" name="angkatan" class="form-control" id placeholder="Masukan Angkatan" required>
                    </div>
                </div>
