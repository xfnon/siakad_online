    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
      ...
      <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="/master-mhs/update" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input type="number" name="no_telp" class="form-control" id="pwd2" value="<?= $mahasiswa->no_telp;?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Alamat :</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" name="alamat" id="exampleFormControlTextarea1" rows="5"><?= $mahasiswa->alamat;?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input type="number" name="tahun" class="form-control" value="<?= $mahasiswa->tahun;?>" required>
                    </div>
                </div>
                <div class="form-group row">
