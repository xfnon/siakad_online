        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse show" id="sidebar-auth" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/admin/semester">
                  <i class="icon">
                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                      <g>
                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <!-- Filter -->
            <div class="card-body">
              <form method="GET" action="<?= base_url('/mahasiswa') ?>" class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <select id="filterSemester" name="semester" class="form-select">
                    ...
                    <?php for ($i = 1; $i <= 8; $i++): ?>
                      <option value="<?= $i; ?>" <?= (isset($_GET['semester']) && $_GET['semester'] == $i) ? 'selected' : ''; ?>>
                        Semester <?= $i; ?>
                      </option>
                    <?php endfor; ?>
                  </select>
                ...
                <div class="col-md-6">
                  ...
                  <select id="filterProdi" name="prodi" class="form-select">
                    <option value="">Semua</option>
                    ...
                    <option value="Desain Komunikasi Visual" <?= (isset($_GET['jurusan']) && $_GET['jurusan'] == 'Desain Komunikasi Visual') ? 'selected' : ''; ?>>Desain Komunikasi Visual</option>
                  </select>
                </div>
              </form>
            </div>
                  ...
                  <tbody>
                    ...
                    foreach ($mahasiswa as $mhs): ?>
                      <tr>
                        ...
                        <td>
                          <a href="/mahasiswa/detail/<?= $mhs['id_mhs']; ?>" class="btn btn-primary btn-sm">Detail</a>
                          <a href="/mahasiswa/edit/<?= $mhs['id_mhs']; ?>" class="btn btn-warning btn-sm">Edit</a>
                          <a href="/mahasiswa/delete/<?= $mhs['id_mhs']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
