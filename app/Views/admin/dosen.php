        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse show" id="sidebar-auth" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/admin/dosen">
                  <i class="icon">
                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                      <g>
                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <div class="modal-body">
                      <form action="/admin/savedosen" method="post">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="nidn" name="nidn" placeholder="Masukkan NIDN" value="<?= old('nidn') ?>">
                            <?php if (isset($errors['nidn'])): ?>
                              <small class="text-danger"><?= $errors['nidn']; ?></small>
                            <?php endif; ?>
                          </div>
                        </div>
                        <div class="form-group row mt-3">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="kode_dosen" name="kode_dosen" placeholder="Masukkan Kode Dosen" value="<?= old('kode_dosen') ?>">
                            <?php if (isset($errors['kode_dosen'])): ?>
                              <small class="text-danger"><?= $errors['kode_dosen']; ?></small>
                            <?php endif; ?>
                          </div>
                        </div>
                        <div class="form-group row mt-3">
                          <label for="kode_dosen" class="col-sm-3 col-form-label">Tipe Dosen:</label>
                          <div class="col-sm-9">
                            <select class="form-control" id="kode_dosen" name="tipe" required>
                              <option value="">Pilih Tipe Dosen</option>
                              <option value="dosenpa" <?= old('kode_dosen') == 'dosenpa' ? 'selected' : '' ?>>Dosen Pembimbing Akademik</option>
                              <option value="dosenmatkul" <?= old('kode_dosen') == 'dosenmatkul' ? 'selected' : '' ?>>Dosen Mata Kuliah</option>
                            </select>
                            <?php if (isset($errors['kode_dosen'])): ?>
                              <small class="text-danger"><?= $errors['kode_dosen']; ?></small>
                            <?php endif; ?>
                        ...
                        <div class="form-group row mt-3">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" placeholder="Masukkan Nama Dosen" value="<?= old('nama_dosen') ?>">
                            <?php if (isset($errors['nama_dosen'])): ?>
                              <small class="text-danger"><?= $errors['nama_dosen']; ?></small>
                            <?php endif; ?>
                          </div>
                        </div>
                        <div class="form-group row mt-3">
                          ...
                          <div class="col-sm-9">
                            ...
                            <?php if (isset($errors['jenis_kelamin'])): ?>
                              <small class="text-danger"><?= $errors['jenis_kelamin']; ?></small>
                            <?php endif; ?>
                          </div>
                        </div>
                        <div class="form-group row mt-3">
              ...
              <div class="table-responsive">
                <table id="datatable" class="table table-striped" data-toggle="data-table">
                  ...
                  <tbody>
                    ...
                    <?php if (!empty($dosen)): ?>
                      ...
                      <?php foreach ($dosen as $row): ?>
                        <tr>
                          ...
                          <td>
                            <?php if ($row['tipe'] == 'dosenpa'): ?>
                              Dosen PA
                            <?php elseif ($row['tipe'] == 'dosenmatkul'): ?>
                              Dosen Matkul
                            <?php else: ?>
                              <?= esc($row['tipe']); ?> <!-- Jika ada tipe lain -->
                            <?php endif; ?>
                          </td>
                          ...
                          <td>
                            <button class="btn btn-primary btn-sm" onclick="editDosen('<?= esc($row['id']); ?>', '<?= esc($row['nidn']); ?>', '<?= esc($row['kode_dosen']); ?>', '<?= esc($row['nama_dosen']); ?>', '<?= esc($row['jenis_kelamin']); ?>', '<?= esc($row['alamat']); ?>')">Edit</button>
                            <a href="/admin/deletedosen/<?= esc($row['id']); ?>"
                    ...
                    <?php else: ?>
                      <tr>
                        <td colspan="7" style="text-align: center;">Tidak ada data dosen</td>
                      </tr>
                    <?php endif; ?>
                  </tbody>
                        ...
                        <div class="modal-body">
                          <form id="editDosenForm" action="/admin/updatedosen" method="post">
                            ...
                            <div class="form-group row mt-3">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="edit_kode_dosen" name="kode_dosen">
                              </div>
                            </div>
                            <div class="form-group row mt-3">
                              <label for="edit_tipe_dosen" class="col-sm-3 col-form-label">Tipe Dosen:</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="edit_kode_dosen" name="tipe">
                              </div>
                            </div>
                            <div class="form-group row mt-3">
                              <label for="edit_nama_dosen" class="col-sm-3 col-form-label">Nama Dosen:</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="edit_nama_dosen" name="nama_dosen">
                              </div>
                            </div>
                            <div class="form-group row mt-3">
                            ...
                            <div class="form-group row mt-3">
                              ...
                              <div class="col-sm-9">
                                <textarea class="form-control" id="edit_alamat" name="alamat" rows="4"></textarea>
                              </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                  ...
                  <script>
                    function editDosen(id, nidn, kode_dosen, nama_dosen, jenis_kelamin, alamat) {
                      ...
                      var modal = new bootstrap.Modal(document.getElementById('editDosenModal'));
                      modal.show();
                    }
                  </script>
