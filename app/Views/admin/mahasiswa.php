...
<head>
    ...
    <title>Masterdata - Mahasiswa</title>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="true" aria-controls="sidebar-user">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse show" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="/admin/mahasiswa">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <div class="modal-body">
                                            <form action="/admin/savemhs" method="post">
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" id="laki_laki" name="jk" value="l" <?= old('jk') === 'Laki-Laki' ? 'checked' : ''; ?> required>
                                                            <label for="laki_laki" class="form-check-label">Laki-Laki</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" id="perempuan" name="jk" value="p" <?= old('jk') === 'Perempuan' ? 'checked' : ''; ?> required>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan No. Telepon" value="<?= old('no_telp') ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="angkatan" name="angkatan" placeholder="Masukkan Tahun Angkatan" value="<?= old('angkatan') ?>" required>
                                                    </div>
                                                </div>
                            ...
                            <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-primary btn-sm"
                                                            onclick="editMahasiswa('<?= $m['id_mahasiswa']; ?>', '<?= $m['nim']; ?>', '<?= $m['nama']; ?>', '<?= $m['jk']; ?>', '<?= $m['no_telp']; ?>', '<?= $m['alamat']; ?>', '<?= $m['prodi']; ?>', '<?= $m['angkatan']; ?>', '<?= $m['semester']; ?>')">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>

                                                        <a href="/admin/deletemahasiswa/<?= $m['id_mahasiswa']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">
                                ...
                                <div class="modal fade" id="editMahasiswaModal" tabindex="-1" aria-labelledby="editMahasiswaModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editMahasiswaModalLabel">Form Edit Mahasiswa</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form id="editMahasiswaForm" action="/admin/updateMahasiswa" method="post">
                                                    <?= csrf_field(); ?>
                                                    <input type="hidden" id="edit_id_mahasiswa" name="id_mahasiswa">

                                                    <div class="form-group row">
                                                        <label for="edit_nim" class="col-sm-3 col-form-label">NIM:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="edit_nim" name="nim" placeholder="Masukkan NIM" required>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row mt-3">
                                                        <label for="edit_nama" class="col-sm-3 col-form-label">Nama:</label>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group row mt-3">
                                                        <label for="edit_jk" class="col-sm-3 col-form-label">Jenis Kelamin:</label>
                                                        <div class="col-sm-9">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" id="edit_laki_laki" name="jk" value="l">
                                                                <label for="edit_laki_laki" class="form-check-label">Laki-Laki</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" id="edit_perempuan" name="jk" value="p">
                                                    ...
                                                    <div class="form-group row mt-3">
                                                        <label for="edit_no_telp" class="col-sm-3 col-form-label">No. Telepon:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="edit_no_telp" name="no_telp" placeholder="Masukkan No. Telepon" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mt-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <textarea class="form-control" id="edit_alamat" name="alamat" placeholder="Masukkan Alamat" required></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mt-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" id="edit_angkatan" name="angkatan" placeholder="Masukkan Tahun Angkatan" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mt-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" id="edit_semester" name="semester" placeholder="Masukkan Semester" required>
                                                        </div>
                                                    </div>
                                ...
                                <script>
                                    function editMahasiswa(id, nim, nama, jk, no_telp, alamat, prodi, angkatan, semester) {
                                        ...
                                        var myModal = new bootstrap.Modal(document.getElementById('editMahasiswaModal'));
                                        myModal.show();
                                    }
                                </script>
