                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Form Setup Jadwal</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="/admin/savejadwal" method="post">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" id="dosen" name="dosen" required>
                                                            ...
                                                            <?php foreach ($dosen as $ds) : ?>
                                                                <option value="<?= esc($ds['nama_dosen']); ?>"><?= esc($ds['nama_dosen']); ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" id="gedung" name="gedung" required>
                                                            ...
                                                            <?php foreach ($ruang as $r) : ?>
                                                                <option value="<?= esc($r['gedung']); ?>"><?= esc($r['gedung']); ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" id="ruang" name="ruang" required>
                                                            ...
                                                            <?php foreach ($ruang as $r) : ?>
                                                                <option value="<?= esc($r['id_ruang']); ?>"><?= esc($r['ruang']); ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="sks" name="sks" placeholder="Masukkan SKS" min="1" max="4" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" id="semester" name="semester" placeholder="Masukkan Semester" min="1" max="8" required>
                                                    </div>
                                                </div>
