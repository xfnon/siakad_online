                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse show" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="/admin/tahun">
                                   <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#inputTahunAjaranModal">
                        Tambah Data
                    </button>

                    <!-- Modal Tambah Tahun Ajaran -->
                    <div class="modal fade" id="inputTahunAjaranModal" tabindex="-1" aria-labelledby="inputTahunAjaranModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="inputTahunAjaranModalLabel">Form Input Tahun Ajaran</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>

                                <div class="modal-body">
                                    <form action="/tahunajaran/save" method="post">
                                        <?= csrf_field(); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="tahun" name="tahun"
                                                    placeholder="Masukkan Tahun Ajaran" value="<?= old('tahun') ?>" required>
                                            </div>
                                        </div>
                        ...
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/tahun/edittahunajaran<?= esc($row['id']); ?>" class="btn btn-primary btn-sm">Edit</a>
                                        <form action="/tahun/deletetahunajaran<?= esc($row['id']); ?>" method="post" class="d-inline">
                                            <?= csrf_field() ?>
