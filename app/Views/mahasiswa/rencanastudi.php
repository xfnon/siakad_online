...
<head>
  ...
  <title>SIAKAD - Rencana Studi</title>
      ...
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item mt-2">
            <a class="nav-link active" aria-current="page" href="/mahasiswa/rencanastudi">
              <i class="icon">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                  <h1>Rencanakan Studi Anda dengan Mudah!</h1>
                  <p>Gunakan sistem ini untuk memilih mata kuliah sesuai dengan rencana studi Anda. Pastikan total SKS yang dipilih sesuai dengan peraturan akademik.</p>
                </div>
              </div>
            </div>
          </div>
