...
<head>
  ...
  <title>SIAKAD - Rekap Nilai</title>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="/mahasiswa/dashboard">
              <i class="icon">
          ...
          <li class="nav-item mt-2">
            <a class="nav-link" aria-current="page" href="/mahasiswa/jadwal">
              ...
              <span class="item-name">Jadwal Perkuliahan</span>
            </a>
          </li>
          <li class="nav-item mt-2">
            <a class="nav-link" aria-current="page" href="/mahasiswa/hasilstudi">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="item-name">Hasil Studi</span>
            </a>
          </li>
          <li class="nav-item mt-2">
            <a class="nav-link active" aria-current="page" href="/mahasiswa/transkripnilai">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="item-name">Transkrip Nilai</span>
            </a>
          </li>
          <li>
            <hr class="hr-horizontal">
          ...
          <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
              <span class="default-icon">Panduan</span>
              <span class="mini-icon">-</span>
            </a>
          </li>
          <li class="nav-item mt-2">
            <a class="nav-link" aria-current="page" href="/mahasiswa/panduankrs">
              ...
              <span class="item-name">Pengisian KRS</span>
            </a>
          </li>
        </ul>
        <!-- Sidebar Menu End -->
  ...
  <main class="main-content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                  <h1>Riwayat Akademik Anda</h1>
                  <p>Dapatkan ringkasan lengkap dari semua mata kuliah yang telah ditempuh beserta nilai akhir.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
      <div class="row">
        <div class="col-md-6">
          <div class="summary-box">
            <h5><i class="bi bi-person-circle"></i> Informasi Mahasiswa</h5>
            <p><strong>Nama:</strong> Muhammad Rizky</p>
            <p><strong>NIM:</strong> 21012345</p>
        ...
        <div class="col-md-6">
          <div class="summary-box">
            <h5><i class="bi bi-award"></i> Ringkasan Akademik</h5>
            <p><strong>IPK:</strong> 3.85</p>
            <p><strong>Total SKS:</strong> 144</p>
      ...
      <div class="mt-4">
        <div class="card shadow-sm border-0">
          <div class="card-header bg-primary text-white">
            <h5 class="fw-bold mb-4 text-white"><i class="bi bi-table"></i> Daftar Nilai</h5>
          </div>
          <div class="card-body">
      ...
      <div class="mt-4 text-end">
        <button class="btn btn-print px-4"><i class="bi bi-printer"></i> Cetak Transkrip</button>
      </div>
    </div>
