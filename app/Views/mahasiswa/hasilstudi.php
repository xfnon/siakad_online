...
<head>
  ...
  <title>SIAKAD - Rekap Hasil Studi</title>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item mt-2">
            <a class="nav-link active" aria-current="page" href="/mahasiswa/hasilstudi">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item mt-2">
            <a class="nav-link" aria-current="page" href="/mahasiswa/transkripnilai">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <main class="main-content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                  <h1>Cek Hasil Studi Anda</h1>
                  <p>Lihat nilai dan capaian akademik Anda selama perkuliahan untuk mengevaluasi performa belajar.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
      <div class="row">
        <div class="card">
          <div class="card-body">
            <h5 class="fw-bold text-primary"><i class="bi bi-person-circle"></i> Data Mahasiswa</h5>
            <table class="table">
              <tr>
                <th>Nama</th>
                <td>John Doe</td>
        ...
        <div class="card mt-4">
          <div class="card-body">
            <h5 class="fw-bold text-primary"><i class="bi bi-book"></i> Daftar Mata Kuliah</h5>
            ...
            <div class="alert alert-info text-center fw-bold mt-3">
              IPK: <span class="text-success fs-5">3.65</span>
            </div>
          </div>
        </div>
      </div>
