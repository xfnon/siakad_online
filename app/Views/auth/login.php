...
<head>
   ...
   <title>SIAKAD Online - Login</title>
                     ...
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           <a href="../../dashboard/index.html" class="navbar-brand d-flex align-items-center mb-3">
                              ...
                              <h4 class="logo-title ms-3">SIAKAD Online</h4>
                           </a>
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="number" name="nim" class="form-control" id="email" aria-describedby="email" required>
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
