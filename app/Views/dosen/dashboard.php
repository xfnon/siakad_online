...
<body class="  ">
      ...
      <div class="sidebar-body pt-0 data-scrollbar">
         <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
               ...
               <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="/mahasiswa/dashboard">
                     <i class="icon">
               ...
               <li class="nav-item mt-2">
                  <a class="nav-link" aria-current="page" href="/mahasiswa/jadwal">
                     ...
                     <span class="item-name">Jadwal Mengajar</span>
                  </a>
               </li>
               <li class="nav-item mt-2">
                  <a class="nav-link" aria-current="page" href="/dosen/absensi">
                     <i class="icon">
                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <li class="nav-item static-item">
                  <a class="nav-link static-item disabled" href="#" tabindex="-1">
                     <span class="default-icon">KRS</span>
                     <span class="mini-icon">-</span>
                  </a>
               </li>
               <li class="nav-item mt-2">
                  <a class="nav-link" aria-current="page" href="/dosen/persetujuan">
                     <i class="icon">
                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <span class="item-name">Persetujuan KRS</span>
                  </a>
               </li>
               <li>
                  <hr class="hr-horizontal">
               ...
               <li class="nav-item static-item">
                  <a class="nav-link static-item disabled" href="/dosen/penilaian" tabindex="-1">
                     <span class="default-icon">Penilaian</span>
                     <span class="mini-icon">-</span>
                  </a>
               </li>
               <li class="nav-item mt-2">
                  <a class="nav-link" aria-current="page" href="/dosen/penilaian">
                     ...
                     <span class="item-name">Nilai Semester</span>
                  </a>
               </li>
               <li>
                  <hr class="hr-horizontal">
   ...
   <main class="main-content">
      ...
      <div class="btn-download">
         <a class="btn btn-success px-3 py-2" href="https://iqonic.design/product/admin-templates/hope-ui-admin-free-open-source-bootstrap-admin-template/">
